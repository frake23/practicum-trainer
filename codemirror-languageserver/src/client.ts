...
export abstract class BaseLanguageClient {
  ...
  public async sendNotification<T extends object = any> (method: string, params: T): Promise<void> {
  ...
  public async makeRequest<T extends object = any, R = any> (method: string, params: T, timeout?: number): Promise<R> {
